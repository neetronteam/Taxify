...
namespace Taxify.DataAccess.Migrations
{
    ...
    [Migration("20231003132530_AddSeetDataMigration")]
    partial class AddSeetDataMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Taxify.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 10, 3, 13, 25, 30, 544, DateTimeKind.Utc).AddTicks(1640),
                            Firstname = "Test",
                            Gender = 0,
                            IsDeleted = false,
                            Lastname = "Testov",
